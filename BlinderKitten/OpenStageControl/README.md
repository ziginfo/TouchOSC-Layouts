...
For the eccess to the Web-Serveur the default port is 8080 (for exemple 127.0.0.1:8080) ... but you can set any other desired port in the OpenStageControl-Setup !
